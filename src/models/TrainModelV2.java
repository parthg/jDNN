...
//    String dictFile = "obj/"+prefix+"/dict.txt";
    String useDict = "dict-word-hash.txt";
...
/*    String file = "data/hi-fire-mono/data.txt";
    ...
    String posFile = "data/data-pos.txt";
    String negFile = "data/data-neg.txt";

    String test_file = "data/data-test.txt";
    String test_posFile = "data/data-pos-test.txt";
    String test_negFile = "data/data-neg-test.txt";
...
/*		pipeline.add(PreProcessTerm.SW_REMOVAL);
    ...
    // *******  TRAIN DATA ************* //
		...
		ch.setup(TokenType.WORD_HASH, lang, path_to_terrier, pipeline);
...
/*    pipeline.remove(PreProcessTerm.SW_REMOVAL);
    pipeline.remove(PreProcessTerm.STEM);*/
		...
		chPos.setup(TokenType.WORD_HASH, lang, path_to_terrier, pipeline);
		Corpus enPos = new Corpus();
    enPos.load(posFile, false, chPos, enDict, fillDict);

		Channel chNeg = new SentFile(negFile);
		chNeg.setup(TokenType.WORD_HASH, lang, path_to_terrier, pipeline);
...
/*		pipeline.add(PreProcessTerm.SW_REMOVAL);
		pipeline.add(PreProcessTerm.STEM);*/
    if(test) {
      chTest.setup(TokenType.WORD_HASH, lang, path_to_terrier, pipeline);
