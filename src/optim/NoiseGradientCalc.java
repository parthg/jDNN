...
public class NoiseGradientCalc implements Optimizable.ByGradientValue {
...
/*  public BasicGradientCalc(Model _model, Sentence _s1, Sentence _s2) {
  ...
  public void setData(Sentence _s1, Sentence _s2, Sentence _s3) {this.s1 = _s1; this.s2 = _s2; this.s3 = _s3;}
  ...
  public double getValue () {
    ...
    DoubleMatrix s3_root = this.model.fProp(this.s3);

    return 0.5*Math.pow(s1_root.distance2(s2_root),2)-0.5*Math.pow(s1_root.distance2(s3_root),2);
  }
...
//    buffer = new double[this.model.getThetaSize()];
    ...
    this.model.bProp(this.s3, this.s1);
    this.model.bProp(this.s1, this.s3);

//    this.model.bProp(this.s3, this.s2);
//    this.model.bProp(this.s2, this.s1);

//    this.model.bProp(this.s2, this.s3);
