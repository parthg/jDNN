...
public class NoiseCosineGradientCalcL2 extends GradientCalc {

  public NoiseCosineGradientCalcL2(Batch _batch) {
    super(_batch);
  }
...
//        System.out.printf("Pos part = %.6f\tNeg Part = %.6f\tReg Part = %.6f\t", posPart, negPart, regPart);
